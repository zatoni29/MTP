...
<div class="row">
  ...
  <div class="col-md-10  pt-2">
     <h3><i class="far fa-question-circle mr-3"></i>DETAIL DATA GURU</h3><hr class="bg-secondary">
    <table class="table">
      <?php
    include('koneksi.php');
    $id = $_GET['id'];
    ...
    <table cellpadding="3" cellspacing="0" >
      <tr>
        <td>Foto</td>
        <td>: <img src="./gambar/<?php echo $data['image']; ?>"></td>
      </tr>
      <tr>
        <td>ID</td>
     ...
     <tr>
      ...
      <a href="data guru.php" class="btn btn-info" ></i>BACK</a>
  </div>
    </div>
