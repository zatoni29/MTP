...
<div class="row">
  ...
  <div class="col-md-10  pt-2">
     <h3></i>INPUT DATA GURU </h3><hr class="bg-secondary">
   ...
   <form action="input_aksi_dataguru.php" method="post" enctype="multipart/form-data">
    ...
    <tr>
      <td>&nbsp;</td>
      <td></td>
      <td><input type="submit" name="tambah" class="btn btn-primary" value="TAMBAH DATA">
        <a href="data guru.php" class="btn btn-danger">KEMBALI</a></td>
    </tr>
  </table>
</form>
  </div>
