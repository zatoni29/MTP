...
<div class="row">
  ...
  <div class="col-md-10  pt-2">
     <h3><i class="far fa-question-circle mr-3"></i>EDIT DATA SEKOLAH </h3><hr class="bg-secondary">

  <?php
    include('koneksi.php');
    $id = $_GET['id'];
    $show = mysql_query("SELECT * FROM sekolah WHERE id='$id'");
   ...
   <form action="update_datasekolah.php" method="post">
    <table cellpadding="3" cellspacing="0" >
     ...
     <tr>
        <td>No Telpon</td>
        <td>:</td>
        <td><input type="text" name="no_telpon" value="<?php echo $data['no_telpon']; ?>" required></td>
      </tr> 
      <tr>
        <td>Kecamatan</td>
        <td>:</td>
        <td><input type="text" name="kecamatan" value="<?php echo $data['kecamatan']; ?>" required></td></td>
      </tr>
      <tr>
        <td>Kabupaten</td>
        <td>:</td>
        <td><input type="text" name="kabupaten" value="<?php echo $data['kabupaten']; ?>" required></td></td>
      </tr>
      <tr>
        <td>Provinsi</td>
        <td>:</td>
        <td><input type="text" name="provinsi" value="<?php echo $data['provinsi']; ?>" required></td></td>
      </tr>
    <tr>
      <td>&nbsp;</td>
      <td></td>
      <td><center><input type="submit" name="simpan" value="Simpan" class="btn btn-outline-success"></center></td></td>
    </tr>
  </table>
</form>
  </div>
