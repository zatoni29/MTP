...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
          <a href="../pages/start_massage.php" class="btn btn-primary btn-block mb-3">Tulis</a>
              ...
              <div class="table-responsive mailbox-messages">
                <table class="table table-hover table-striped">
                  ...
                  <tr>
                    ...
                    <td class="mailbox-subject"><b>Pesan Masuk</b> - Trying to find a solution to this problem...
                    </td>
