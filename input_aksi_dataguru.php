...
if(isset($_POST['tambah'])){
	...
	$alamat= $_POST['alamat'];
	$tanggal_lahir= $_POST['id'];
	$bidang_studi= $_POST['bidang_studi'];
	$pendidikan= $_POST['pendidikan'];

	//melakukan query dengan perintah INSERT INTO untuk memasukkan data ke database
	$input = mysql_query("INSERT INTO guru VALUES('$id','$nama','$jenis_kelamin','$agama','$jabatan','$email','$no_hp','$alamat','$tanggal_lahir','$bidang_studi','$pendidikan')");
