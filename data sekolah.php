...
<div class="row">
  ...
  <div class="col-md-10  pt-2">
     <h3><i class="far fa-question-circle mr-3"></i>DATA SEKOLAH</h3><hr class="bg-secondary">
    ...
    <table class="table">
      ...
      <tr>
          <td>No Telpon: <?php echo $data['no_telpon']; ?></td>
      </tr>
      <tr>
        <td>Kecamatan: <?php echo $data['kecamatan']; ?></td>
      </tr>
      <tr>
        <td>Kabupaten: <?php echo $data['kabupaten']; ?></td>
      </tr>
      <tr>
        <td>Provinsi: <?php echo $data['provinsi']; ?></td>  
      </tr>
      
      <?php } ?>
    </table>
    <a  href="edit_datasekolah.php" class="btn btn-primary">Edit Data</a>
